...
/**
 * Main extension bootstrap.
 * The extension class is loaded early but gracefully exits if Divi isn't active.
 */
...
add_action( 'divi_extensions_init', 'dm5_initialize_extension' );
